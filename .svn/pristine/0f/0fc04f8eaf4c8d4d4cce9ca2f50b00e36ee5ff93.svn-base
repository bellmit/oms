...
<!--------------- Content start ----------------->
    ...
    <div class="content-wrapper" >
        ...
        <section class="container-fluid">
            <div class="row">
                <!-- search start -->
                <div class="searchType-select fn-hide">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 pro-search pro-search-wd" style="margin-left: -18px;">
                                       <input type="text" class="" name="proName" style="width: 180px;"/>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-md-3">
           ...
           <div class="proList-nav proList-nav-wd">
            <div class="proTop">
                ...
                <button  type="button" class="line-btn fn-right" ng-click="toAddProduct('1')">添加新商品</button>
                <div class="fn-clear"></div>
            </div>
                  ...
                  <tr ng-repeat="pro in proList track by $index">
                   <td width="2%"><input type="checkbox" id="{{pro.proModelid}}" data="{{pro.publishStatus}}" name="modelId" class="code_checkbox" value="{{pro.proModelid}}" /></td>
                    ...
                    <td width="20%">
                        ...
                        <p ng-if="pro.attrArr.length==0">货号：{{pro.proModelnum}}</p>
                    ...
                    <td ng-if="pro.attrArr.length==0">{{pro.brandName}}</td>
                    <td ng-if="pro.attrArr.length!=0&&pro.proSortId=='130906332'">{{pro.attrArr[0].attrValue}}</td>
                    <td ng-if="pro.attrArr.length!=0&&(pro.proSortId=='130906333'||pro.proSortId=='130906334')">{{pro.attrArr[1].attrValue}}</td>
                    ...
                    <td>
                    	<a href="javascripr:;" class="am-ft-d4" ng-click="toAddProduct('2',pro)">编辑</a>
                    </td>
                    <td class="" >
                        <a class="am-ft-d4" ng-if="pro.publishStatus==0" ng-click="addProductWD(pro)">上架</a>
                        <a class="am-ft-d4" ng-if="pro.publishStatus==1" ng-click="downProductWD(pro)">下架</a>
                    </td>
                  </tr>
              </table>
              <!-- List end -->
