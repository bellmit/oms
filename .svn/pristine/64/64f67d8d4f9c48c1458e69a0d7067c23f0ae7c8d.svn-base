qyApp.controller("alterPswordController", function($scope, $http, Upload,$timeout) {
		/*
		 * 资料修改
		 */
		...
		$scope.checkNewPassWord2=function(){
			...
			if($scope.password.password == $scope.password.newPassWord){
				$scope.newPassWordWarn3=true;
			}else{
				$scope.newPassWordWarn3=false;
			}
		}
