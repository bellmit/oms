...
<!--遮罩 end-->
<!--------------- Content start ----------------->
<a href="javascript:;" class="line-btn forwardTop-goBack" ng-click="goback()">返回</a>
<div class="content-wrapper content-wrapper-itemshow2">
	<div class="forwardTop-content" style="margin-bottom: 15px;">
			<div class="forwardTop-left">
				 <img ng-src="{{orgManageColor.shopLogo}}" ng-if="orgManageColor.shopLogo != '' " />
                 <img src="http://static.qineasy.com/base/images/img_default_company.png" ng-if="orgManageColor.shopLogo == '' " />
			</div>
			<div class="forwardTop-right">
				<div class="forwardTop-righttop">
					<p href="javascript:;" class="forwardTop-rightTitl">{{orgManageColor.shopName}}</p>
					<div class="fn-clear"></div>
				</div>
				<p class="am-ft-black forwardTop-middle">
					<span class="stores-count">店铺数：<a href="javascript:;">{{orgManageColor.shopNum}}</a>个</span>
					<span class="mgl10">运营人员：{{orgManageColor.userName}}
						<!--<a href="javascript:;" class="mgl5 allotOprate">更换</a></span>-->
				</p>
				<p class="fn-clear">
					<span class="fn-left">联系电话：{{orgManageColor.shopTel}}</span>
					<span class="fn-left mgl35">详细地址：{{orgManageColor.province}}{{orgManageColor.city}}{{orgManageColor.district}}{{orgManageColor.shopAddr}}</span> 
					<span class="fn-right am-ft-gray">商户添加时间：{{orgManageColor.openDate}}</span>
				</p>
			</div>
		</div>  
   	<div class="col-md-11 pageTitl">
		...
		颜色管理
            ...
            <!--<a href="javascript:;" class="line-btn fn-right" ng-click="gobackcolor()">返回</a>-->
		
	</div>
    <!-- Main content -->
    <div class="ManColTable col-md-12">
   		<div class="col-md-12 checkType">
            <a href="javascript:;" class="activeItem" ng-click="getAllColorA()">所有颜色</a>
            <a href="javascript:;" ng-click="getSystem(this)">按色系查看</a>
        </div>
        <form id="colorForm">
            <div class="table-responsive PrivTable" style="margin-left: 0px;">
	                    ...
	                    <tr ng-repeat="item in items">
	                        ...
	                        <td>
							 ...
							 <div class="uploadNav" onmouseover="mouseOver(this)" onmouseout="mouseOut(this)">
								 ...
								 <img class="uploadImg" alt="颜色图片" ng-src="{{item.imagesPath}}" id="color{{item.colorId}}" ng-model="item.imagesPath" style="width: 70px;height:40px;">
    ...
    <!--分页 start-->
     <div class="pagelist priv-pagelist">
    	<div id="pagingsystemcolor"></div>    
    </div>
    <div class="pagelist priv-pagelist">
    	<div id="pagingcolor"></div>    
    </div>
    <!--分页 end-->
