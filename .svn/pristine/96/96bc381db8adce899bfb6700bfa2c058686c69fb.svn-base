...
<div class="col-md-12" ng-if="imgListCountZs ==0 && userInfo.orgType == '6'">
	<div class="loadingFormal">
		...
		<div class="mgt20" style="position: relative; width:130px;margin: 0 auto;">
			<input  type="file" style="left:0" ngf-select="addImageB($files)" ngf-multiple="true" class="fn-left loadImgFolder"/>
