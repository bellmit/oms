<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
    ...
    <div class="content-wrapper content-forwardAdd-wrapper pb20">
        ...
        <section class="container-fluid">
                    ...
                    <div class="prodet-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group needValInfo">
                                <input type="text" class="col-md-8 text-overflow" name="shopName" placeholder="" value="" ng-model="shopName" ng-blur="checkCmName()" style="width: 200px;" />
                            	<span class="error mgl5" ng-show="userNameWarn">该商户已存在！</span>
                            </div>
                        </div>
                            ...
                            <div class="col-md-10 form-group pro-property mgl5">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 form-group needValInfo">
                                        <input type="text" class="col-md-5 text-overflow" autocomplete="off" name="userName" placeholder="" value="" ng-model="orgUserName" ng-blur="checkUserName(orgUserName)"/>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-9 form-group needValInfo">
                                        <input type="text" class="col-md-5 text-overflow" autocomplete="off"  id="trueNamea" placeholder="" value="" ng-model="trueName" ng-blur="checkUserName(trueName)"/>
            ...
            <button type="button" id="addmerchantBtn" class="btn btn-primary addBrandBtn" ng-click="addMerchant(this)">确认添加</button>
