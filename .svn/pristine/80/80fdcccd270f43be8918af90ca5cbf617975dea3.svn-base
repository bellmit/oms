qyApp.controller("updateCommerciaController", function ($scope,$http,$timeout) {
    ...
    $http.get('/oms/pos/commercia/province.json').success(function(data)
    {
    ...
    $http.get('/oms/pos/commercia/city.json').success(function(data)
    {
        $scope.citys = data;
    });
    //请求区文件
    $http.get('/oms/pos/commercia/district.json').success(function(data)
    {
