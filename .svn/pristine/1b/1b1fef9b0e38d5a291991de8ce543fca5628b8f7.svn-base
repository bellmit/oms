			...
			<div class=" freight-row fn-clear">
				...
				<div class="fn-left fn-clear col-md-11 pl0 pr0">
					<div class="fn-left fn-clear freight-useshop mgr20 mgb15" ng-repeat="shopList in shopLists">
						<input type="checkbox" class="mgr5 mgt0" ng-click="chooseOrgId(shopList.orgId)">
		...
		<div class="area-dialog">
			...
			<div class="area-list fn-clear" ng-repeat="arrList in areaArr track by $index">
				<div class="fn-left area-name">
					...
					<span>
						<span>{{arrList.pArea.locationName}}</span>
			...
			<div class="area-list fn-clear" ng-repeat="specialArea in specialAreaArr track by $index">
				<div class="fn-left area-name">
				...
				<div class="fn-left area-name" ng-repeat="arr in specialArea.cArea track by $index" ng-click="selectArea('2',specialArea,$index)">
					<input type="checkbox" ng-model="arr.doSelect" />
