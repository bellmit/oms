qyApp.controller('operationDetailsController', ['$scope', '$http', '$compile', '$state', '$stateParams','Upload', function($scope, $http, $compile, $state, $stateParams,Upload) {
	...
	$scope.getContractTabBack=function(data){
		if($scope.tabType=="3"){
			$scope.contractTabInfo=data.contractInfo;
		}
	}
