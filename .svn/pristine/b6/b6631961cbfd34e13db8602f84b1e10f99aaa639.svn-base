...
<div class="content-wrapper">
	<div class="col-md-11 pageTitl">
		<h2 class="am-ft-16 fn-left">编辑商品</h2>
	...
	<form id="productForm">
		...
		<section class="container-fluid">
			<div class="row">
				<div class="prodet-nav prodet-content">
                    ...
                    <div class="col-md-8 form-group" id="ProSorts">
                        <select class="col-md-3" ng-options="m.sortId as m.sortName for m in items" ng-model="selected" ng-change="sortIdchange()">
                        </select>
                        <select class="col-md-3" ng-options="c.sortId as c.sortName for c in itemsc" ng-model="selectedc" ng-change="sortIdCchange()">
                        </select>
                        <select class="col-md-3" ng-options="g.sortId as g.sortName for g in itemsg" ng-model="selectedg">
                        </select>  
                        <input type="hidden" name="proSortId" value="{{selectedg}}" /> 
                        <input type="hidden" name="proParentSortId" value="{{selectedc}}" /> 
                        <input type="hidden" name="proGrandparentSortId" value="{{selected}}" /> 
                        <input type="hidden" name="proModelid" value="{{proModelid}}" />             
					</div>
                </div>-->
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-2 form-group">
								<select class="col-md-12" ng-options="m.brandId as m.brandName for m in itemsb" ng-model="brandId">
						...
						<div class="row">
							...
							<div class="col-md-8 form-group">
								<input type="text" class="col-md-8 text-overflow" name="proName" placeholder="" value="" />
							</div>
						</div>
						<!----row4---->
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-2 form-group needValInfo">
								<input type="text" class="col-md-10 text-overflow" name="proPrice" placeholder="" value="" ng-model="editProPrice" />&nbsp;元
							</div>
						</div>
						<!----row7商品规格---->
						<div class="row">
									...
									<div class="proSize-info">
										<div class="row">
											<div class="col-sm-2" ng-repeat="color in colors">
												<input name="{{color.colorId}}" type="checkbox" ng-model="x" ng-checked="isSelected(color.colorId)" ng-click="chkColor(color.colorId,x,color.colorName,color.colorNum)" name="colorId" value="{{color.colorId}}" />
									...
									<div class="proSize-info">
										<div class="row">
											<div class="col-sm-2" ng-repeat="size in sizes">
												<input type="checkbox" ng-model="s" ng-checked="isSelectedSize(size.sizeId)" ng-click="chkSize(size.sizeId,s,size.sizeName,size.sizeNum)" name="sizeId" value="{{size.sizeId}}" />
							...
							<div class="col-md-10 form-group table-responsive corlorSizeTable" style="margin-left: 25px;">
								<table width="100%" class="table table-condensed">
	                                ...
	                                <div ng-repeat="sizes in SizeNumAndName" class="mgb10">
	                                	<input id="{{colors.colorId+sizes.sizeId+'Edit2'}}" name="editProSkuPrice" type="text" value="{{editProPrice}}"/>
	                                </div>
	                            </td>    -->
										<td>
											<div ng-repeat="sizes in SizeNumAndName" class="mgb10">
												<input id="{{colors.colorId+sizes.sizeId+'Edit'}}" name="editProInterbc" type="text" value="" />
											</div>
										</td>
										<td>
											<div ng-repeat="sizes in SizeNumAndName" class="mgb10 color-size">
												{{styleNumber}}{{colors.colorNum}}{{sizes.sizeNum}}
												<input id="{{colors.colorId+sizes.sizeId+'Edit1'}}" name="editProInnerbc" type="hidden" value="{{styleNumber}}{{colors.colorNum}}{{sizes.sizeNum}}" />
											</div>
										</td>
									</tr>
								</table>
								...
								<div class="mainPhot">
									<div class="row">
										...
										<div class="col-md-3" style="width: 20%">
											<div class="photoBox">
												<div class="photoBg">
													<input type="file" name="files" ngf-select="uploadMain($files,'mainEdit1','0')" value="" />
													<img alt="" src="http://static.qineasy.com/base/images/photobg.jpg" id="mainEdit1">
												</div>
												<div class="phoboxbt">
													<a ng-click="clearImage('mainEdit1')"><i class="fa fa-close"></i></a>
													<a ng-click="moveImage('mainEdit1','mainEdit2','Edit')"><i class="fa fa-chevron-right"></i></a>
										...
										<div class="col-md-9">
											<div class="photoBox">
												<div class="photoBg">
													<input type="file" name="files" ngf-select="uploadMain($files,'mainEdit2','0')" value="" />
													<img alt="" src="http://static.qineasy.com/base/images/photobg.jpg" id="mainEdit2">
												</div>
												<div class="phoboxbt">
													<a ng-click="clearImage('mainEdit2')"><i class="fa fa-close"></i></a>
													<a ng-click="moveImage('mainEdit2','mainEdit3','Edit')"><i class="fa fa-chevron-right"></i></a>
													<a ng-click="moveImage('mainEdit1','mainEdit2','Edit')"><i class="fa fa-chevron-left"></i></a>
												</div>
											</div>
											<div class="photoBox">
												<div class="photoBg">
													<input type="file" name="files" ngf-select="uploadMain($files,'mainEdit3','0')" value="" />
													<img alt="" src="http://static.qineasy.com/base/images/photobg.jpg" id="mainEdit3">
												</div>
												<div class="phoboxbt">
													<a ng-click="clearImage('mainEdit3')"><i class="fa fa-close"></i></a>
													<a ng-click="moveImage('mainEdit3','mainEdit4','Edit')"><i class="fa fa-chevron-right"></i></a>
													<a ng-click="moveImage('mainEdit2','mainEdit3','Edit')"><i class="fa fa-chevron-left"></i></a>
												</div>
											</div>
											<div class="photoBox">
												<div class="photoBg">
													<input type="file" name="files" ngf-select="uploadMain($files,'mainEdit4','0')" value="" />
													<img alt="" src="http://static.qineasy.com/base/images/photobg.jpg" id="mainEdit4">
												</div>
												<div class="phoboxbt">
													<a ng-click="clearImage('mainEdit4')"><i class="fa fa-close"></i></a>
													<a ng-click="moveImage('mainEdit4','mainEdit5','Edit')"><i class="fa fa-chevron-right"></i></a>
													<a ng-click="moveImage('mainEdit3','mainEdit4','Edit')"><i class="fa fa-chevron-left"></i></a>
												</div>
											</div>
											<div class="photoBox">
												<div class="photoBg">
													<input type="file" name="files" ngf-select="uploadMain($files,'mainEdit5','0')" value="" />
													<img alt="" src="http://static.qineasy.com/base/images/photobg.jpg" id="mainEdit5">
												</div>
												<div class="phoboxbt">
													<a ng-click="clearImage('mainEdit5')"><i class="fa fa-close"></i></a>
													<a ng-click="moveImage('mainEdit5','mainEdit1','Edit')"><i class="fa fa-chevron-right"></i></a>
													<a ng-click="moveImage('mainEdit4','mainEdit5','Edit')"><i class="fa fa-chevron-left"></i></a>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="mainPhot" ng_repeat="colors in ColorNumAndName">
									...
									<div class="row">
										<div class="col-md-3" style="width: 20%">
											<div class="photoBox">
												<div class="photoBg">
													<input type="file" name="" ngf-select="uploadMain($files,colors.colorId+'Edit1','0')" value="" />
													<img alt="" src="http://static.qineasy.com/base/images/photobg.jpg" id="{{colors.colorId+'Edit1'}}">
												</div>
												<div class="phoboxbt">
													<a ng-click="clearImage(colors.colorId+'Edit1')"><i class="fa fa-close"></i></a>
													<a ng-click="moveImage(colors.colorId+'Edit1',colors.colorId+'Edit2','Edit')"><i class="fa fa-chevron-right"></i></a>
													<a href="javascript:;" class="fn-hide"><i class="fa fa-chevron-left"></i></a>
												</div>
											</div>
										</div>
										<div class="col-md-9">
											<div class="photoBox">
												<div class="photoBg">
													<input type="file" name="" ngf-select="uploadMain($files,colors.colorId+'Edit2','0')" value="" />
													<img alt="" src="http://static.qineasy.com/base/images/photobg.jpg" id="{{colors.colorId+'Edit2'}}">
												</div>
												<div class="phoboxbt">
													<a ng-click="clearImage(colors.colorId+'Edit2')"><i class="fa fa-close"></i></a>
													<a ng-click="moveImage(colors.colorId+'Edit2',colors.colorId+'Edit3','Edit')"><i class="fa fa-chevron-right"></i></a>
													<a ng-click="moveImage(colors.colorId+'Edit1',colors.colorId+'Edit2','Edit')"><i class="fa fa-chevron-left"></i></a>
												</div>
											</div>
											<div class="photoBox">
												<div class="photoBg">
													<input type="file" name="" ngf-select="uploadMain($files,colors.colorId+'Edit3','0')" value="" />
													<img alt="" src="http://static.qineasy.com/base/images/photobg.jpg" id="{{colors.colorId+'Edit3'}}">
												</div>
												<div class="phoboxbt">
													<a ng-click="clearImage(colors.colorId+'Edit3')"><i class="fa fa-close"></i></a>
													<a ng-click="moveImage(colors.colorId+'Edit3',colors.colorId+'Edit4','Edit')"><i class="fa fa-chevron-right"></i></a>
													<a ng-click="moveImage(colors.colorId+'Edit2',colors.colorId+'Edit3','Edit')"><i class="fa fa-chevron-left"></i></a>
												</div>
											</div>
											<div class="photoBox">
												<div class="photoBg">
													<input type="file" name="" ngf-select="uploadMain($files,colors.colorId+'Edit4','0')" value="" />
													<img alt="" src="http://static.qineasy.com/base/images/photobg.jpg" id="{{colors.colorId+'Edit4'}}">
												</div>
												<div class="phoboxbt">
													<a ng-click="clearImage(colors.colorId+'Edit4')"><i class="fa fa-close"></i></a>
													<a ng-click="moveImage(colors.colorId+'Edit4',colors.colorId+'Edit5','Edit')"><i class="fa fa-chevron-right"></i></a>
													<a ng-click="moveImage(colors.colorId+'Edit3',colors.colorId+'Edit4','Edit')"><i class="fa fa-chevron-left"></i></a>
												</div>
											</div>
											<div class="photoBox">
												<div class="photoBg">
													<input type="file" name="" ngf-select="uploadMain($files,colors.colorId+'Edit5','0')" value="" />
													<img alt="" src="http://static.qineasy.com/base/images/photobg.jpg" id="{{colors.colorId+'Edit5'}}">
												</div>
												<div class="phoboxbt">
													<a ng-click="clearImage(colors.colorId+'Edit5')"><i class="fa fa-close"></i></a>
													<a ng-click="moveImage(colors.colorId+'Edit5',colors.colorId+'Edit1','Edit')"><i class="fa fa-chevron-right"></i></a>
													<a ng-click="moveImage(colors.colorId+'Edit4',colors.colorId+'Edit5','Edit')"><i class="fa fa-chevron-left"></i></a>
												</div>
											</div>
										</div>
									</div>
			...
			<!-- /.row -->
			<button type="button" class="btn btn-primary postProInfo" ng-click="updateProduct(this)">发布</button>
...
<script>
	$(function() {
			var formArray = [];
			formArray.push('{"productForm":"/product/updateProduct"}');
