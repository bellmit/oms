...
<div class="col-md-12">
	...
	<div ng-if="tabType=='1'" >
		<div class="flowLog fn-clear mgt20">
			...
			<div  class="flowLogR flowLogRFirst">
				<button class="grey_bg_black" ng-click="addLog(4)" ng-if="processTaskManagerUser==userInfo.userId||userInfo.userId=='1973'">＋资料审核</button>
				<button class="grey_bg_black" ng-click="addLog(5)" ng-if="processTaskManagerUser==userInfo.userId||userInfo.userId=='1973'">＋服务审核</button>
			</div>
		</div>
	...
	<div ng-if="tabType=='2'" >
		<div class="flowLog fn-clear mgt20">
			...
			<div  class="flowLogR flowLogRFirst">
				<button class="grey_bg_black" ng-click="addLog(7)" ng-if="serverTaskManagerUser==userInfo.userId||userInfo.userId=='1973'">＋内部质检</button>
				<button class="grey_bg_black" ng-click="addLog(8)" ng-if="userInfo.roleId=='13'||userInfo.userId=='1973'">＋续签反馈</button>
				<button class="grey_bg_black" ng-click="addLog(9)" ng-if="userInfo.roleId=='20'||userInfo.userId=='1973'">＋QC抽检</button>
			</div>
		</div>
		<!--/审批结果-->
				...
				<div class="flowLogR2 fn-clear" ng-if="serverTask.taskType=='10'">
					...
					<div class="flowLogR2_box  fn-clear" style="border-top: 1px solid #FAEAD1;" ng-if="serverTask.dealResult==''&&!showServiceDeal">
						...
						<div class="flowLogR2_boxR ">
							...
							<button class="blueGroundWhiteBtn fn-right mgt5 w70" ng-click="dealServiceTask(this)" ng-if="productManagerId==userInfo.userId||userInfo.userId=='1973'">审核</button>
						</div>
					</div>
					<!--暂停审批-->
					<div class="flowLogR2_box  fn-clear" style="border-top: 1px solid #FAEAD1;" ng-if="serverTask.dealResult==''&&showServiceDeal">
