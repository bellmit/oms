					...
					<form id="addproductForm">
						...
						<div class="row">
							...
							<div class="col-md-2 form-group pr0 mgr5" id="ProSorts">
								<select class="col-md-12"
									...
									ng-model="proSortId" ng-change="changeSort(proSortId)" ng-disabled="true">
								</select>
							</div>
						</div>
						<!--row4
						<div class="row">
							...
							<div class="col-md-2 form-group">
								<input type="text" placeholder="" value="{{pro.proUom}}" />
							</div>
						</div>--row5---->
								...
								<div class="row">
									...
									<div class="col-md-4 form-group">
										<input type="text" class="text-overflow" name="proModelnum"
												placeholder="" value="{{pro.proModelnum}}" />
									...
									<div class="col-md-4 form-group">
										<input type="text" name="brandName" placeholder="" value="{{pro.brandName}}" />
									</div>
									<div class="col-md-2 inprodet-titl am-ft-12">
										<em class="am-ft-red mgr5">*</em>年份：
									</div>
									<div class="col-md-4 form-group">
										<select name="proYear" class="col-md-8" ng-model="pro.proYear"
									...
									<div class="col-md-4 form-group">
										<select name="proSeason" class="col-md-8" ng-model="pro.proSeason">
						...
						<div class="row">
							...
							<div class="col-md-8 form-group">
								<input type="text" class="col-md-8 text-overflow" name="proName" placeholder="" value="{{pro.proName}}" />
							</div>
						</div>
						<!----row7--
						<div class="row">
							...
							<div class="col-md-2 form-group needValInfo">
								<input type="text" class="col-md-10 text-overflow" name="proPrice" placeholder="" value="{{pro.proPrice}}" />&nbsp;元
							</div>
						</div>-->
						</form>
						<!----row8商品规格---->
						...
						<div class="row">
							...
							<div class="col-md-10">
								<button type="button" class="btn btn-primary mgr10" ng-click="updateProudctWd()">保存</button>
