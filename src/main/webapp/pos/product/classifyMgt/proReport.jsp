           ...
           <div class="proList-nav classifyList-nav">
            <div class="proTop">
                ...
                <table width="100%" class="mgb0 table-hover table-condensed productTable">
                  <tr>
                    <th width="15%"    valign="middle" scope="col">分类名称</th>
                    <th width="15%" align="center" valign="middle" scope="col">商品数量</th>
                    <th width="20%" align="center" valign="middle" scope="col">添加时间</th>
                    <th width="25%" align="center" valign="middle" scope="col">操作</th>
                   <th  align="center" valign="middle" scope="col">位置</th>
                  </tr>
                  <tr >
                  <!--<tr ng-repeat="pro in proList track by $index">-->
                   <td >
                   	<div class="editClassifyName fn-hide">
	                   	<input type="text" id="" data="" name="modelId" class="code_checkbox " value="" /><br />
	                   	<span class="am-ft-d4">保存</span>
	                   	<span  class="am-ft-d4">取消</span>
                   	</div>
                   	<div class="">
                   		<span>分类名称</span>
                   		<img src="../static/base/images/icon_edit.png" />
                   	</div>
                   </td>
                    <td >
                        32个
