			...
			<div class="fn-clear col-md-12 contractBaseInfoBox">
				<div class="contractInfo col-md-12">
					<div class="infoLine infoLinea fn-clear">
						...
						<span class="color333 mgl25" ng-if="contractTabInfo.contractType==1">（原合同：{{contractTabInfo.sourceContractNum}}）</span>
					</div>
									...
									<div class="proType_box_under pro_account">
										<div class="proType_box_contenr">
											<div class="proType_detailsBox fn-clear">
												...
												<div class="proType_details">
													<span class="color333">2017-03-10</span>
												</div>
											</div>
										</div>
										<div class="proType_box_contenr">
											<div class="proType_detailsBox fn-clear">
												...
												<div class="proType_details">
													<span class="color333">服务质量达不到要求，请求暂停，内部调整</span>
												</div>
											</div>
										</div>
										<div class="proType_box_contenr">
										...
										<div class="proType_box_contenr">
											<div class="proType_detailsBox fn-clear">
												...
												<div class="proType_details ">
													<span class="am-ft-orangeS fn-left">1000元</span>
													<div class="fn-left mgl60">
														<span class="color666">已收款金额：</span>
														<span class="am-ft-orangeS">500元</span>
													</div>
												</div>
											</div>
										</div>
										<div class="proType_box_contenr proType_box_contenr_last">
											<div class="proType_detailsBox fn-clear">
												<div class="" >
													费用结算：
												</div>
												<div class="proType_details ">
													<span class="am-ft-orangeS">8500元</span>
													<span class="am-ft-blue fn-hide">-8500元</span>
													<div class="fn-left mgl60">
														<span class="color666">处理：</span>
														<span class="am-ft-black">不退款，结转客户余额</span>
													</div>
												</div>
											</div>
										</div>
