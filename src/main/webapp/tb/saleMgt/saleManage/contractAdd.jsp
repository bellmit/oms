			...
			<div class="fn-clear col-md-12 contractBaseInfoBox">
				<div class="contractInfo col-md-12">
					...
					<div class="infoLine infoLinea fn-clear" >
						...
						<div ng-if='showContinue=="0"'>
							<span class="color333" >新签合同</span>
						</div>
						<div ng-if='showContinue=="1"'>
							<select class="color333"  ng-model='model.contractType' >
								<option value="0">新签合同</option>
					...
					<div class="infoLine infoLinee fn-clear">
						...
						<div class="proType_box fn-left">
							...
							<div class="proType_box_a proType_box_ab">
								<form id='operation'>
									<div class="proType_box_nav">
