...
qyApp.controller("sizeController", function ($scope, $http,$compile,Upload,$q) {
	...
	$scope.addSize=function(groupId){
		if(validateForm("sizeForm","msg")==true){
			...
			var json={"groupId":groupId,"sizeNum":sizeNum,"sizeName":sizeNameUpper,"sizeIndex":sizeIndex};
