	...
	<div class="col-lg-12">
		...
		<div class="col-md-11 storeProBox publicImgBox">
			...
			<div class="handleDialog moveDialog fn-hide">
				...
				<ul>
					<li ng-repeat="attr in attrList" ng-click="moveImages(attr.proAttrId)" ng-if="attr.proAttrValue == ''"><i class="fa fa-folder"></i>{{attr.proAttrFilePath}}</li>
				</ul>
			</div>
			<!---- /移动弹窗 ---->
			...
			<div class="col-md-12 mgb10 select-wrap">
				...
				<a href="javascript:;" class="morehandles" ng-click="postImg('imgs',this.attr)" ng-if="userInfo.orgType == '6'"> 
				...
				<a href="javascript:;" class="morehandles am-ft-gray"ng-if="userInfo.orgType == '6'" ng-click="delImages()"> 
			...
			<div class="col-md-12 fodderMainRow fodderMainRow3">
				<!--新建文件夹-->
				<div class="fodderMain fodderMain-default" id="addFolder" ng-click="addFolderPub()" ng-if="userInfo.roleId == '1' || userInfo.roleId == '2'">
				...
				<!--上传文件-->
				<div class="fodderMain fodderMain-default" id="addFilesPub" ng-if="userInfo.roleId == '1' || userInfo.roleId == '2'">
					<div class="fodderMainImg">
				...
				<!--文件夹-->
				<!--<div class="fodderMain"  ng-repeat="attr in attrList| filter:{'proAttrValue':''}" ng-model="attr" >-->
				<div class="fodderMain" ng-repeat="attr in attrList track by $index" ng-model="attr" ng-if="attr.proAttrValue == ''">
				...
				<!--文件-->
				<!--<div class="fodderMain" index="{{$index}}" foldtype="proimg" ng-model="attr" ng-repeat="attr in attrList | filter:{'proAttrValue':'!'}" id="material{{attr.proAttrId}}P">-->
				<div class="fodderMain"  index="{{$index}}" foldtype="proimg" ng-model="attr" ng-repeat="attr in attrList track by $index" ng-if="attr.proAttrValue != ''" id="material{{attr.proAttrId}}P">
					<div class="fodderMainImg " ng-click="doSelect(this,'P')">
						...
						<div class="cover" ng-if="userInfo.orgType == '6'">
							<a href="javascript:;" class="scan am-ft-white mgr20" ng-click="$event.stoppropagation()">预览</a>
