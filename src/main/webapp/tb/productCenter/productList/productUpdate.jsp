				...
				<div class="prodet-nav prodet-content">
					<div class="prodet-box">
						...
						<div class="row">
							...
							<div class="col-md-8 form-group" id="ProSorts">
								<select class="col-md-3 mgr5" ng-show="item1.length != 0" ng-options="p.sortId as p.sortName for p in item1" ng-model="selectSortId1" ng-change="sortIdChange(selectSortId1,2)">
								</select>
						...
						<div class="row">
							...
							<div class="col-md-2 form-group">
								<select class="col-md-12" ng-options="m.brandId as m.brandName for m in queryBrands" ng-model="brandIds" ng-change="changeProName()">
						...
						<div class="row">
							...
							<div class="col-md-2 form-group">
								<input type="text" class="text-overflow" name="proModelnum" placeholder="" ng-model="styleNumber" ng-blur="changeProName()" />
							</div>
							...
							<div class="col-md-10 form-group pro-property">
								...
								<div class="row">
									...
									<div class="col-md-4 form-group">
										<select name="proYear" class="col-md-8" ng-model="proYear" ng-change="changeProName()">
											<option value="{{year}}" ng-repeat="year in years">{{year}}</option>
										</select>
									</div>
									<div class="col-md-2 inprodet-titl am-ft-12">季节：</div>
									<div class="col-md-4 form-group">
										<select name="proSeason" class="col-md-8" ng-model="proSeason" ng-change="changeProName()">
								...
								<div class="row">
									...
									<div class="col-md-4 form-group">
										<select name="proSex" class="col-md-8" ng-model="proSex" ng-change="changeProName()">
								...
								<div class="row">
									...
									<div class="col-md-4 form-group">
										<input type="text" class="col-md-8 text-overflow" name="proSeries" placeholder="" ng-model="proSeries" ng-blur="changeProName()"/>
									</div>
									<div class="col-md-2 inprodet-titl am-ft-12">风格：</div>
									<div class="col-md-4 form-group">
										<input type="text" class="col-md-8 text-overflow" name="proStyle" placeholder="" ng-model="proStyle" ng-blur="changeProName()"/>
									</div>
								</div>
							</div>
						</div>
