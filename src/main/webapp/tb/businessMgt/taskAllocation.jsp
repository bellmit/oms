...
<div class="contractCreate-wraper contractCreate-wraperaa fn-clear contractCreate-wraper-info">
			...
			<div class="contractInfo col-md-12">
				...
				<div class="infoLine infoLinee fn-clear">
					...
					<div class="w800 fn-left mgl0 line-cut" ></div>	
						<!--区域分配-->
	<div class="fn-clear addContractBox border-blue w800 fn-left mgl0" ng-if="currentTask.taskStatus=='1'&&(step=='1'||userInfo.userId=='1973')">
		<div class="fn-clear col-md-12 contractBaseInfoBox">
	...
	<!--/区域分配-->
	<!--主管分配-->
	<div class="col-md-11 fn-clear addContractBox border-blue w800 fn-left mgl0" ng-if="currentTask.taskStatus=='2'&&(step=='2'||userInfo.userId=='1973')">
		<div class="fn-clear col-md-12 contractBaseInfoBox">
	...
	<!--/主管分配-->
	<!--执行人接收-->
	<div class="col-md-11 fn-clear addContractBox border-blue w800 fn-left mgl0" ng-if="currentTask.taskStatus=='3'&&(step=='3'||userInfo.userId=='1973')">
		<div class="fn-clear col-md-12 contractBaseInfoBox">
