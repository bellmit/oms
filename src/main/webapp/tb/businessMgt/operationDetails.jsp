...
<div class="firstTab col-md-11 mgl20 mgt10">
		<ul class="fn-clear">
	...
	<div ng-if="tabType=='2'">
		<div class="flowLog fn-clear mgt20">
			...
			<div  class="flowLogR flowLogRFirst">
				<button class="grey_bg_black" ng-click="addLog(6)">＋内部质检</button>
				<button class="grey_bg_black" ng-click="addLog(7)">＋续签反馈</button>
				<button class="grey_bg_black" ng-click="addLog(8)">＋QC抽检</button>
			</div>
		</div>
