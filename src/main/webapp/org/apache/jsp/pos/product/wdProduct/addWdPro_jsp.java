 ...
 * Generated at: 2017-03-30 08:28:44 UTC
...
public final class addWdPro_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\tng-model=\"proSortId\" ng-change=\"changeSort(proSortId)\">\n");
      out.write("\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<!--row4\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" ng-model=\"proUom\" placeholder=\"\" />\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>--row5---->\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tng-model=\"proModelnum\" placeholder=\"\" />\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-2 inprodet-titl am-ft-12\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<em class=\"am-ft-red mgr5\">*</em>品牌：\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-4 form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"brandName\" placeholder=\"\" />\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-4 form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<select name=\"proYear\" class=\"col-md-8\" ng-model=\"proYear\"\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-10\">\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary mgr10\" ng-click=\"addProudctWd(proSortId)\">确认添加</button>\n");
